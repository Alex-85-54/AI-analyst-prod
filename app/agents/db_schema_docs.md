...
# Таблица: events
Описание: события - действия клиента на сайте интернет-магазинов: просмотр товара, покупка, добавление в корзину, удаление из корзины, добавление в избранное 
-  **shop_id** :   ID магазина                        (uint32)       
-  **client_id** :  ID клиента                        (uint64)       
-   **event** : событие - действия клиента на сайте интернет-магазина  (string)       
-   **code**:          код                             (string)       
